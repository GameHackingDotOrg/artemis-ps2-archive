...
Preset joker / joker_array (in .conf file) format:

Sony ID, Joker address, Ver #

Example: "SCUS_974.65", 0x001EE682, "1.00"

If you do not provide a ver number it will work but keep in mind some games have multiple versions
