...
lui t0, $8005
lw t0, $0058(t0)
lq t0, $0010(t0) //Gets first part of the dumper
bne t0, zero, 3
nop
jal :_installDumper
nop
...
lui s2, $8005
lw s2, $0018(s2) //Storage
addiu s3, zero, 300

_printJokLoop:
beq s0, s1, :_exitpJLoop
lw t0, $0000(s0)
beq t0, zero, :_printJokLoopNext
nop
...
lui t0, $8005
lw t0, $0058(t0)
addiu t0, t0, $0010 //Store location
lui t1, $8004
...
//lui k0, $????
//ori k0, k0, $????
//Sets pointer to register store
addiu t1, t0, $0100
srl t2, t1, 16
sh t1, $0014(t0) //Originally 3C1A0000 (lui k0, $0000)
sh t2, $0010(t0) //Originally 375A0000 (ori k0, k0, $0000)
...
lui t0, $8005
lw t0, $0058(t0)
addiu t0, t0, $0010 //Pointer to reg dumper
sw t7, $00A8(t0) //Store installaddr's op
sw t8, $00B0(t0) //Store j $install addr + 8
...
and v0, t0, t1 //If t0 and t1 is 1, returns 1. Otherwise returns 0
lq t0, $0000(sp)
lq t1, $0010(sp)
jr ra
addiu sp, sp, $0020
...
lui s5, $8005
lw s5, $0058(s5) //What the RegD is hooked to
lui s4, $8004
ori s4, s4, $5200
...
lw a1, $0018(s1) //Pointer to processed value
//addiu a1, a1, $0060
lw a0, $001C(s1)
addiu t0, zero, 110
addiu t1, zero, 355
...
//add t1, t1, t2
daddu t6, a0, zero //Byte read address
_ASCIILoop2:
lb t0, $0000(t6) //Value
...
lui t0, $8005
ori at, t0, $6000
sw at, $0044(t0) //Location of pointer to current stored result
sw at, $0048(t0) //Location of pointer to current place to store result to
...
lw at, $0048(t0) //Load storing result pointer
sw v0, $0000(at) //Store address for changed/unchanged
sw v1, $0004(at) //Store value for changed/unchanged
...
lui v1, $8005
lb v0, $0110(v1) //Loads bit (8 = 0, 16 = 1, or 32 = 2)
...
sll t0, s1, 2 //Pretty much multiplies by 4
addu t0, s3, t0
sw t0, $0020(s0)
...
//Designed this way so that a 0x00 won't cut off the rest of the string
addiu a1, s1, 1
lw a0, $001C(s0)
addiu t0, zero, 290
addiu t1, zero, 65
...
//So out of laziness I decided to change how the packet it handled here
//Instead of updating each jal to this with the new packet setup
//This location of the packet is stored at 0x80050050
