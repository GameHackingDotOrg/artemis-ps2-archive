...
vmode_t vmodes[] = {
	...
	,{NTSC, 256, 224, 0, 32, 10}	// NTSC_256_512_32
	,{NTSC, 320, 224, 0, 32, 8}		// NTSC_320_256_32
	,{NTSC, 384, 224, 0, 32, 7}		// NTSC_384_256_32
	,{NTSC, 512, 224, 0, 32, 5}		// NTSC_512_256_32
	,{NTSC, 640, 224, 0, 32, 4}		// NTSC_640_256_32
};
