...
extern void ntpbclient_irx;
extern int  size_ntpbclient_irx;
...
void SendIrxRAM(void)
{
	...
	irxptr_tab[2].irxsize = size_ntpbclient_irx; 	
...
{	
	init_scr();
	scr_clear();
	scr_printf("\t CORE LAUNCHER - v0.92\n\n");
